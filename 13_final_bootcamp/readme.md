...
*Вывод*
- корректность А/В теста под сомнением по нескольким причинам. Основная причина: неравномерно распределены тестовые группы
...
*Вывод*
- в ходе исследования выработаны две модели монетизации: первичная и альтернативная. Альтернативная модель имеет улучшения, меняющие рекламную нагрузку на пользователей. Альтернативная модель снижает количество показов рекламы при клике в меню строительства с 89% до 68%.
...
*Вывод*
- Автор с самой высокой оценкой книг: Джоан Роулинг
- Самым продуктивным издательством является 'Yearling Books'
